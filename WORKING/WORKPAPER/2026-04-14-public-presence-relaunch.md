...
- [ ] CN-Grafiken erstellen oder Legende anfertigen
...
### Geändert
- `README.md` — Ersetzt durch deutsche Version (vorher englisch)
- `docs/index.html` — Komplett auf Deutsch umgebaut, Sprachschalter, Showcase-Tabelle, neue Sektionen
